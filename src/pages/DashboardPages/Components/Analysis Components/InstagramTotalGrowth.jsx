const InstagramTotalGrowth = ({sample, week}) =>{
    ...
    return(
        <div>
        <div 
            className=" h-96 border-2 shadow-md rounded-lg mb-5 flex  gap-4 flex-wrap  bg-white w-6/6 p-4 tr">
                ...
                <div className="flex flex-row w-[100%] h-2/6 ">
                    ...
                    <div
                    className="flex flex-col justify-center items-center w-3/12">
                        <div className="text-lg">Total Interactions</div>
                        <div><p className="inline text-lg">{ sample[week].totalInteractions }</p> 
